...
class ImpressionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create impression" do
    assert_difference('Impression.count') do
      post impressions_url, params: { impression: { content: @impression.content, from_id: @impression.from_id, to_id: @impression.to_id } }
    end
  ...
  test "should update impression" do
    patch impression_url(@impression), params: { impression: { content: @impression.content, from_id: @impression.from_id, to_id: @impression.to_id } }
