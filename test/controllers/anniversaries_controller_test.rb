...
class AnniversariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anniversary" do
    assert_difference('Anniversary.count') do
      post anniversaries_url, params: { anniversary: { couple_id: @anniversary.couple_id, day: @anniversary.day, month: @anniversary.month, title: @anniversary.title, year: @anniversary.year } }
    end
  ...
  test "should update anniversary" do
    patch anniversary_url(@anniversary), params: { anniversary: { couple_id: @anniversary.couple_id, day: @anniversary.day, month: @anniversary.month, title: @anniversary.title, year: @anniversary.year } }
