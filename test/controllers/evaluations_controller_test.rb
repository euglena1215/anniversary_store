...
class EvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post evaluations_url, params: { evaluation: { event_id: @evaluation.event_id, rate: @evaluation.rate, user_id: @evaluation.user_id } }
    end
  ...
  test "should update evaluation" do
    patch evaluation_url(@evaluation), params: { evaluation: { event_id: @evaluation.event_id, rate: @evaluation.rate, user_id: @evaluation.user_id } }
